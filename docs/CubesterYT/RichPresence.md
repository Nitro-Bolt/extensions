...
The Rich Presence SDK will be automatically downloaded and enabled when a project using the Rich Presence extension is put into the [NitroBolt Packager](https://packager.nitrobolt.org/). You will need to select one of these environments:
