...
(async function (Scratch) {
  ...
  GUSPatSynth_ChangePitchWheel = Module.cwrap("GUSPatSynth_ChangePitchWheel", null, ["number", "number", "number"]);
  ...
  class TurboSynth {
    ...
    setProgram(args) {
      ...
      return synth[args.SYNTH].promise.then(() => {
        GUSPatSynth_SetProgram(synth[args.SYNTH].synth, args.CHANNEL, args.PROGRAM, 0);
      });
    }
    ...
    changePitchWheel(args) {
      ...
      return synth[args.SYNTH].promise.then(() => {
        GUSPatSynth_ChangePitchWheel(synth[args.SYNTH].synth, args.CHANNEL, args.SEMITONE);
      });
    }
